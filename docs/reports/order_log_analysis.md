...
- mode=**real**, status=**success**: 659 条
...
| 可能为老虎真实单（order_id 为纯数字） | 595 | **未与老虎核对**，可能含测试污染；真实成功数仅以老虎后台为准。 |
...
- 2026-03-31T21:03:20.206749
- 2026-03-31T21:03:58.672766
- 2026-03-31T21:04:27.460337
