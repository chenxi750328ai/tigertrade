...
生成时间: 2026-04-30T16:47:13.895596
...
| 项目 | 值 | 说明 |
| --- | --- | --- |
| **实际收益率（老虎后台核对）** | -14100.98 USD（浮动-14100.98） | 仅老虎后台订单/成交计算；未拉取或未核对时见上方空项根因。 |
...
| --- | --- | --- | --- | --- | --- |
| moe_transformer | 144.0 | 10.42 | 0.0 | 0.03 | 98.6 |
| lstm | 144.0 | 10.42 | 0.0 | 0.03 | 98.6 |
| grid | 11.0 | 29.31 | 2.66 | 7.21 | 100.0 |
