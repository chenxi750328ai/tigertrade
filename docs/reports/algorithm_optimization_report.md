...
生成时间: 2026-02-10T16:22:56.886112
...
| 项目 | 值 | 说明 |
| --- | --- | --- |
| **实际收益率（老虎后台核对）** | —（需老虎后台数据核对） | 仅老虎后台订单/成交计算；未拉取或未核对时为 —。 |
| **推算收益率（未核对）** | — | 未与老虎核对时的推算值；无推算时为 —。 |
...
| --- | --- | --- | --- | --- | --- |
| moe_transformer | 20.0 | 1.6 | 0.01 | 0.03 | 100.0 |
| lstm | 20.0 | 1.6 | 0.01 | 0.03 | 100.0 |
