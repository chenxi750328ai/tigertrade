...
3. **配置文件中的 account 存在**（`account=21415812702670778`），但传递链路断裂
...
# 结果：
✅ [API初始化] account已设置: 21415812702670778
api_manager._account = 21415812702670778
api_manager.trade_api.account = 21415812702670778
✅ account传递测试通过
```
...
运行后检查日志，确认：
1. ✅ 启动时显示：`✅ [API初始化] account已设置: 21415812702670778`
2. ✅ 下单时显示：`🔍 [下单调试] account=21415812702670778, ...`
