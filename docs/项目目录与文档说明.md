...
| **推送** | `push_until_success.sh` | 推送重试直到成功（陈正霞例行用）。 |
...
| 子目录/文件 | 用途 |
|-------------|------|
| **best_practices/** | Agent 必读：**例行工作清单_agent必读.md**（7 项例行）、**陈正霞陈正与协作分工**、**状态页刷新规范**、**订单LOG说明**、**手工订单与自动订单关系**、**项目角色与每日例行工作** 等。 |
...
| 例行 7 项 | shared_rag/best_practices/例行工作清单_agent必读.md、agentfuture 侧陈正霞开工必读 |
