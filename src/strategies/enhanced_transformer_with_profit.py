"""
支持收益率预测的Enhanced Transformer模型
基于EnhancedTradingTransformer，添加收益率预测头
"""
import torch
...
class EnhancedTradingTransformerWithProfit(nn.Module):
    """支持收益率预测的增强型Transformer模型"""
    def __init__(self, input_size=46, nhead=8, num_layers=8, output_size=3, d_model=512, predict_profit=True):
        super(EnhancedTradingTransformerWithProfit, self).__init__()
