...
#   0 1 * * * /path/to/tigertrade/scripts/cron_qa_monitor.sh >> /path/to/tigertrade/logs/qa_monitor.log 2>&1
# 或与例行错开（如每日 2:00 UTC）:
#   0 2 * * * /path/to/tigertrade/scripts/cron_qa_monitor.sh >> /path/to/tigertrade/logs/qa_monitor.log 2>&1
